	...
	public class LogSetupTest extends MockitoTestCase {
		...
		public function testTargetIntegration():void {
			...
			if(    _logger.debugEnabled
				...
				inOrder().verify().that(logTarget.log(eq(""), eq(""), eq(DEBUG), anyOf(Number), eq("debug1"), alike([1, 2, myObject]), eq(null), eq(null), eq(null)));
				inOrder().verify().that(logTarget.log(eq(""), eq(""), eq(INFO),  anyOf(Number), eq("info1"),  alike([1, 2, myObject]), eq(null), eq(null), eq(null)));
				inOrder().verify().that(logTarget.log(eq(""), eq(""), eq(WARN),  anyOf(Number), eq("warn1"),  alike([1, 2, myObject]), eq(null), eq(null), eq(null)));
				inOrder().verify().that(logTarget.log(eq(""), eq(""), eq(ERROR), anyOf(Number), eq("error1"), alike([1, 2, myObject]), eq(null), eq(null), eq(null)));
				inOrder().verify().that(logTarget.log(eq(""), eq(""), eq(FATAL), anyOf(Number), eq("fatal1"), alike([1, 2, myObject]), eq(null), eq(null), eq(null)));
			} else {
			...
			if(     _logger.debugEnabled
				...
				inOrder().verify().that(logTarget.log(eq(""), eq(""), eq(DEBUG), anyOf(Number), eq("debug2"), alike([1, 2, myObject]), eq(null), eq(null), eq(null) ));
			} else {
			...
			if(    !_logger.debugEnabled
				...
				inOrder().verify().that(logTarget.log(eq(""), eq(""), eq(INFO), anyOf(Number), eq( "info3" ), alike([1, 2, myObject]), eq(null), eq(null), eq(null)));
				inOrder().verify().that(logTarget.log(eq(""), eq(""), eq(WARN), anyOf(Number), eq( "warn3" ), alike([1, 2, myObject]), eq(null), eq(null), eq(null)));
				inOrder().verify().that(logTarget.log(eq(""), eq(""), eq(ERROR), anyOf(Number), eq( "error3" ), alike([1, 2, myObject]), eq(null), eq(null), eq(null)));
				inOrder().verify().that(logTarget.log(eq(""), eq(""), eq(FATAL), anyOf(Number), eq( "fatal3" ), alike([1, 2, myObject]), eq(null), eq(null), eq(null)));
			} else {
			...
			if(    !_logger.debugEnabled
				...
				_logger.error("Should not be called");
				_logger.fatal("Should not be called");
				inOrder().verify().that(logTarget.log(eq(""), eq(""), eq(INFO), anyOf(Number), eq("info4"), alike([1, 2, myObject]), eq(null), eq(null), eq(null) ));
			} else {
			...
			if(    !_logger.debugEnabled
				...
				inOrder().verify().that(logTarget.log(eq(""), eq(""), eq(WARN), anyOf(Number), eq( "warn5" ), alike([1, 2, myObject]), eq(null), eq(null), eq(null)));
				inOrder().verify().that(logTarget.log(eq(""), eq(""), eq(ERROR), anyOf(Number), eq( "error5" ), alike([1, 2, myObject]), eq(null), eq(null), eq(null)));
				inOrder().verify().that(logTarget.log(eq(""), eq(""), eq(FATAL), anyOf(Number), eq( "fatal5" ), alike([1, 2, myObject]), eq(null), eq(null), eq(null)));
			} else {
			...
			if(    !_logger.debugEnabled
				...
				_logger.error("Should not be called");
				_logger.fatal("Should not be called");
				inOrder().verify().that(logTarget.log(eq(""), eq(""), eq(WARN), anyOf(Number), eq("warn6"), alike([1, 2, myObject]), eq(null), eq(null), eq(null) ));
			} else {
			...
			if(    !_logger.debugEnabled
				...
				inOrder().verify().that(logTarget.log(eq(""), eq(""), eq(ERROR), anyOf(Number), eq( "error7" ), alike([1, 2, myObject]), eq(null), eq(null), eq(null)));
				inOrder().verify().that(logTarget.log(eq(""), eq(""), eq(FATAL), anyOf(Number), eq( "fatal7" ), alike([1, 2, myObject]), eq(null), eq(null), eq(null)));
			} else {
			...
			if(    !_logger.debugEnabled
				...
				_logger.fatal("Should not be called");
				inOrder().verify().that(logTarget.log(eq(""), eq(""), eq(ERROR), anyOf(Number), eq("error8"), alike([1, 2, myObject]), eq(null), eq(null), eq(null) ));
			} else {
			...
			if(    !_logger.debugEnabled
				...
				inOrder().verify().that(logTarget.log(eq(""), eq(""), eq(FATAL), anyOf(Number), eq( "fatal9" ), alike([1, 2, myObject]), eq(null), eq(null), eq(null)));
			} else {
			...
			if(    !_logger.debugEnabled
				...
				_logger.error("Should not be called");
				_logger.fatal("Should not be called");
				logTarget.log("", "", DEBUG, 123.0, "test", null, null, null, null);
				inOrder().verify().that(logTarget.log(eq(""), eq(""), eq(DEBUG), anyOf(Number), eq( "test" ), eq(null), eq(null), eq(null), eq(null)));
			} else {
				fail("The Logsystem tells logging is not enabled @ fatal.");
			}
			...
			if(     _logger.debugEnabled
				...
				_logger.fatal("Should not be called");
				inOrder().verify().that(logTarget.log(eq(""), eq(""), eq(DEBUG), anyOf(Number), eq( "debug10" ), alike([1, 2, myObject]), eq(null), eq(null), eq(null)));
				inOrder().verify().that(logTarget.log(eq(""), eq(""), eq(ERROR), anyOf(Number), eq( "error10" ), alike([1, 2, myObject]), eq(null), eq(null), eq(null)));
			} else {
				fail("The Logsystem tells logging is not enabled @ fatal.");
			}
		}
