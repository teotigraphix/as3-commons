package org.as3commons.logging {
	...
	public class LogSetupTest extends MockitoTestCase {
		...
		public function testEmptyCase(): void {
			var setup: ILogSetup = new TargetSetup( null, LogTargetLevel.ALL );
			LoggerFactory.setup = setup;
		...
		public function testTargetIntegration():void {
			...
			var setup: TargetSetup = new TargetSetup(logTarget, LogTargetLevel.DEBUG);
			LoggerFactory.setup = setup;
			...
			LoggerFactory.setup = new TargetSetup(logTarget,LogTargetLevel.DEBUG_ONLY);
			verifyNothingCalled( logTarget );
			if(     _logger.debugEnabled
				&& !_logger.infoEnabled
				&& !_logger.warnEnabled
			...
			LoggerFactory.setup = new TargetSetup( logTarget,LogTargetLevel.INFO);
			...
			LoggerFactory.setup = new TargetSetup( logTarget,LogTargetLevel.INFO_ONLY);
			...
			LoggerFactory.setup = new TargetSetup( logTarget,LogTargetLevel.WARN);
			...
			LoggerFactory.setup = new TargetSetup( logTarget,LogTargetLevel.WARN_ONLY);
			...
			LoggerFactory.setup = new TargetSetup( logTarget,LogTargetLevel.ERROR);
			...
			LoggerFactory.setup = new TargetSetup( logTarget,LogTargetLevel.ERROR_ONLY);
			...
			LoggerFactory.setup = new TargetSetup( logTarget,LogTargetLevel.FATAL);
			...
			LoggerFactory.setup = new TargetSetup( logTarget,LogTargetLevel.NONE);
			...
			LoggerFactory.setup = new TargetSetup( logTarget,LogTargetLevel.DEBUG_ONLY.or( LogTargetLevel.ERROR_ONLY ));
