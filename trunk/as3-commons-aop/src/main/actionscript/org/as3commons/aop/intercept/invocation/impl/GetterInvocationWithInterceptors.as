...
package org.as3commons.aop.intercept.invocation.impl {
	...
	public class GetterInvocationWithInterceptors implements IGetterInvocation {
		...
		public function GetterInvocationWithInterceptors(proxy:*, getter:Accessor, args:Array, interceptors:Vector.<IInterceptor>) {
			_proxy = proxy;
			_getter = getter;
			_args = args;
		...
		private function invokeJoinpoint():* {
			return target[getter.name]; //return _args[0];
		}
